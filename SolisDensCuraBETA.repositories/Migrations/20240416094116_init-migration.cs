        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDentist = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_Clinics_ClinicId",
                        column: x => x.ClinicId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DentistFees = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuppliesReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SuppliesReports_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SuppliesReports_Supply_SuppliesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescriptions_Supply_SuppliesId",
                        column: x => x.SuppliesId,
                        principalTable: "Supply",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_SuppliesId",
                table: "Prescriptions",
                column: "SuppliesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SuppliesReports_SupplierId",
                table: "SuppliesReports",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_SuppliesReports_SuppliesId",
                table: "SuppliesReports",
                column: "SuppliesId");
